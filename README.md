...
**I then opened codespace and wrote code to connect to Azure ↓**
...
**In my Program.cs code, I added options for automated file upload, download, etc. ↓**
...
**BUT wait, what if the file got corrupted? lets check the integrity of the file using SHA-256: (again, automation >>>)**
↓
...
**Im not satisfied there. lets try automation of bulk files. so i add 'bulk file automation code' to the program.cs framework. 
